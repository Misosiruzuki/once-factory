package com.oncefactory.client;
...
public class CrusherScreen extends AbstractContainerScreen<CrusherMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(OnceFactory.MODID, "textures/gui/crusher.png");
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
        ...
        int x = (width - imageWidth) / 2;
        int y = (height - imageHeight) / 2;
        String lifeText = Component.translatable("gui.oncefactory.life",
                menu.getRemainingLife(), menu.getMaxLife()).getString();
        graphics.drawString(this.font, lifeText, x + 8, y + 58, 0x404040, false);
        String energyText = Component.translatable("gui.oncefactory.energy",
